        ...
        <div class="form-container ">
            <div class="form ">
                <form action="/newPassword" method="POST">
                    @csrf
                    <h2 style="font-size:x-large;">Change Password</h2>
                        @if(session('fail'))
                    ...
                    <input type="password" name="userNewPassword" placeholder="Enter new password" value={{ $user -> user_pwd}} required><br>
                    <label>Confirm new password</label>
                    <input type="password" name="confirmNewPassword" placeholder="Confirm new password" value={{ $user -> user_pwd}} required><br>
                    <div>
        ...
        <div class="form-container ">
            <div class="form ">
                <form action="" method="POST">
                    <h2 style="font-size:x-large;">Change Password</h2>
                    <label>New password</label>
                    <input type="password" name="userNewPassword" placeholder="Enter new password" required><br>
                    <label>Confirm new password</label>
