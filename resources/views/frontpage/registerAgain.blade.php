    ...
    <div class="main-box">
        <form action="register" method="POST" style="border:1px solid #ccc;" class="form-box">
            ...
            <div class="container">
                ...
                <input type="text" placeholder="Enter Username" name="userName" value={{$request -> input('userName')}} required>

                <label for="Email"><b>Email</b></label>
                <input type="email" placeholder="Enter Email" name="userEmail" required>

                <label for="Password"><b>Password</b></label>
                <input type="Password" placeholder="Enter Password" name="userPassword" value={{$request -> input('userPassword')}} required>

                <label for="Password"><b>Telephone</b></label>
                <input type="text" placeholder="phone number" name="phoneNumber" value={{$request -> input('phoneNumber')}} required>
