...
@section('content')
    ...
    <!-- Content -->
    <div class="main-box">
        <form action="uploadBook" method="POST" style="border:1px solid #ccc;" class="form" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <h1 style="font-weight: bold; font-size:x-large;margin-bottom:10px;">Upload Book</h1>
                <p>Please fill in this form to upload the new book.</p>
                ...
                <div class="input-form">
                    ...
                    <input type="text" placeholder="Enter Author" name="bookAuthor">
                </div>
                
                <div class="input-form">
                    <label for="Publiser"><b>Publiser</b></label>
                    <input type="text" placeholder="Enter Publiser" name="bookPubliser">
                </div>
                
                <div class="input-form">
                    <label for="Description"><b>Description</b></label>
                    <textarea type="text" placeholder="Enter Description" name="bookDescription"  style="width:100%; height:100px;"> </textarea>
                </div>
                
                <div class="input-form">
                    <label for="Image"><b>Image</b></label>
                    <div>
                        <input type="file" placeholder="Upload image" name="bookImage">
                    </div>
                ...
                <div class="input-form">
                    ...
                    <input type="text" placeholder="Enter BookSource" name="bookSource">
                </div>
